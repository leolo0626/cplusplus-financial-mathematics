...
const double ROOT_2_PI = sqrt( 2.0 * M_PI );
...
static void testIntegral() {
    ...
    double actual = integral(integrand, 1.0, 3.0, 1000);
    double expected = -cos(3.0) + cos(1.0);
    cout << "Actual of Integral " << actual << "\n";
    cout << "Expected of Integral " << expected << "\n";
    ...
    NormalPDF integrand2;
    double actual2 = integral(integrand2, -1.96, 1.96, 1000);
    double expected2  = 2 * normcdf(1.96) -1 ;
    cout << "Actual of Integral for normcdf from -1.96 to 1.96 " << actual2 << "\n";
    cout << "Expected of Integral for normcdf from -1.96 to 1.96 " << expected2 << "\n";
}
